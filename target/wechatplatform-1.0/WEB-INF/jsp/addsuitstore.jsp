...
<body>
    <div class="content">
        ...
        <div class="bodycont addsuitstore ">
            <div class="importToolip display">
                ...
                <div class="errorInfo display">
                    <a class="closetoolip icon-remove" onclick="closetoolip()"></a>
                    <p><img src="images/success.png">审核驳回</p>
                    <p class="importInfo">
                        <span>原因</span>
                    </p>
                </div>
                <div class="waitloading display">
                    <a class="closetoolip icon-remove" onclick="closetoolip()"></a>
                    <p><img src="images/success.png">审核中</p>
                    <p class="importInfo">
            ...
            <div class="pull-left rightcont">
                <a class="choseStorebtn" onclick="chosestore()">...</a>
        ...
        <div class="surebtn">
            <button class="btn btn-primary" data="0" onclick="saveData(this)">保存</button>
            <button class="btn btn-primary" data="1" onclick="saveData(this)">保存并继续</button>
        </div>
    </div>
    <!--选择门店-->
