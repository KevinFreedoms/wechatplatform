...
<div class="content addcouponcont">
    ...
    <div class="couponcontent bodycont">
        ...
        <div class="col-md-11 rightcont">
            <input type="text" id="privilegebatch" value="${count.privilegeBatch}" disabled="disabled"/>
        </div>
        <div class="clearfloat"></div>
        ...
        <div class="col-md-11 rightcont activeType">
            <label class="demonlabel" onClick="choseStatus(0,this)">
                <input class="beautycheckbox" type="checkbox" ${count.activityType eq 0 or count.activityType eq 3 or count.activityType eq 4 or count.activityType eq 6 ?"checked":""} data-id="0" id="duobei">
                <span class="democheckbox checkInput"></span>消费送多倍积分
            </label>
            <label class="demonlabel" onClick="choseStatus(1,this)" >
                <input class="beautycheckbox" type="checkbox" ${count.activityType eq 1 or count.activityType eq 3 or count.activityType eq 5 or count.activityType eq 6 ?"checked":""} data-id="1" id="birth">
                <span class="democheckbox checkInput"></span>赠送生日优惠券
            </label>
            <label class="demonlabel" onClick="choseStatus(2,this)">
                <input class="beautycheckbox" type="checkbox"  ${count.activityType eq 2 or count.activityType eq 4 or count.activityType eq 5 or count.activityType eq 6 ?"checked":""}  data-id="2" id="zhekou">
        ...
        <div class="col-md-11 rightcont" style="position:relative">
            <input type="text" readonly name="reservation" id="reservation" class="reservation datainput" value="${count.birthdayStartDate} - ${count.birthdayEndDate}"/>
            <i class="icon-calendar" style="position:absolute;left:185px; top:8px;"></i>
        </div>
        <div class="clearfloat"></div>
        <div class="intergralmutiple ${count.activityType eq 0 or count.activityType eq 3 or count.activityType eq 4 or count.activityType eq 6 ?"":"display"}">
            <div class="col-md-1 leftlabel"><label class="defaultLabel">积分倍数：</label></div>
            <div class="col-md-11 rightcont">
                <input type="text" value="${count.multiple}" class="inputIntegral"  style="text-align:right" id="multiple" onkeyup="regmu(this)" onblur="mublur(this)"/>
            </div>
            <div class="clearfloat"></div>
        </div>
        <div class="birthdaycoupon ${count.activityType eq 1 or count.activityType eq 3 or count.activityType eq 5 or count.activityType eq 6 ?"":"display"}">
            <div class="col-md-1 leftlabel"><label class="defaultLabel">生日优惠券：</label></div>
            <div class="col-md-11 rightcont">
                <input type="text" name='couponBatch' id="couponBatch" class="yhqcode" disabled value="${count.couponBatch}" />
            ...
            <div class="col-md-11 rightcont">
                <input type="text" class="yhqnumber"  name="couponCount" value="${count.couponCount}" style="text-align:right" id="couponCount" onkeyup="regbir(this)" onblur="birblur(this)" onfocus="birfocus(this)" />
            </div>
            <div class="clearfloat"></div>
        </div>
        <div class="discount ${count.activityType eq 2 or count.activityType eq 4 or count.activityType eq 5 or count.activityType eq 6 ?"":"display"}">
            <div class="col-md-1 leftlabel"><label class="defaultLabel"><span class="importantinfo">*</span>折扣率：</label></div>
            <div class="col-md-11 rightcont">
                <input type="text" class="inputdiscount" value="${count.discountRate}" style="text-align:right"  id="discountRate" onkeyup="inputVerification(this)" onblur="inputBlur(this)"/>
        ...
        <div class="col-md-11 rightcont">
            <textarea id="editor_id" name="content" style="width:40%;height:280px;visibility:hidden;margin-left:10px;">${count.activeContent}</textarea>
        </div>
        <div class="clearfloat"></div>
        <div class="col-md-1 leftlabel"><label class="defaultLabel title">是否启用：</label></div>
        <div class="col-md-11 rightcont">
            <label class="demonlabel">
                <input class="beautycheckbox allchose" type="checkbox" ${count.ref1 eq '1'?"checked":""} id="isUse">
        ...
        <div class="col-md-11 rightcont">
            <textarea rows="5" cols="50" style="resize:none" id="remark">${count.remark}</textarea>
        </div>
        <div class="clearfloat"></div>
    </div>
    <div class="surebtn">
    ...
    <input type="hidden" name="recKey" value="${count.recKey}" id="recKey"/>
</div>
<!--选择优惠券-->
...
<script type="text/javascript">
    ...
    $('.reservation').daterangepicker({
        startDate: '${count.birthdayStartDate}',
        endDate: '${count.birthdayEndDate}',
        separator : ' - ',
    });
