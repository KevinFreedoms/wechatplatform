...
<body>
    <div class="content">
        ...
        <div class="bodycont addcouponpage">
            ...
            <div id="yhqtype">
                ...
                <div class="col-md-11 rightcont" id="coupontype">
                    <input type="text" id="couponTypeed" disabled/>
                </div>
                <div class="clearfloat"></div>
            </div>
            <div class="reciveType">
                ...
                <div class="col-md-11 rightcont" id="recivetype">
                    <input type="text" id ="reciveTypeed" disabled/>
                </div>
                <div class="clearfloat"></div>
            </div>
        ...
        <div class="surebtn">
            <button class="btn btn-primary" onclick="saveupdate()">保存</button>
        </div>
    </div>
    <!--简单描述-->
    ...
    <script type="text/javascript">
        $(function () {
            basePath = "<%=basePath%>";
            modifcouponRow=${wxcouponcollect};
            getCouponBatch();
        });
    </script>
</body>
