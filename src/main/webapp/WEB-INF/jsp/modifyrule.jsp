        ...
        <div class="couponcontent bodycont">
            ...
            <div class="col-md-11 rightcont">
                <label class="radiobeuty" data-id="0" onclick="choseactive(0)">
                    <input class="defaultradio" data-id="0"  type="radio" name="active" ${rule.isMoney eq 1?"checked":""}>
                    <span class="radioInput"></span>赠送金额
                </label>
                <label class="radiobeuty" data-id="1" onclick="choseactive(1)">
                    <input class="defaultradio" data-id="1" type="radio" name="active" ${rule.isCoupon eq 1?"checked":""}>
            ...
            <div class="col-md-11 rightcont">
                <input type="text" onkeyup="numMoney(this)" name="money" value="${rule.money}"/>
            ...
            <div class="present">
                ...
                <div class="col-md-11 rightcont">
                    <input type="text" onkeyup="numMoney(this)" name="presentMoney" value="${rule.presentMoney}"/>
                    <span class="lsdw">元</span>
                </div>
                <div class="clearfloat"></div>
            </div>
            ...
            <div class="col-md-11 rightcont">
                <input type="text" disabled="disabled" name="actualMoney" value="${rule.actualMoney}"/>
                <span class="lsdw">元</span>
            </div>
            <div class="clearfloat"></div>
            <div class="choseyhq display">
                ...
                <div class="col-md-11 rightcont">
                    <input type="text" disabled="disabled" name="couponBatch" value="${rule.couponBatch}"/>
                ...
                <div class="col-md-11 rightcont">
                    <input type="text" name="couponCount" value="${rule.couponCount}"onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}">
            ...
            <div class="col-md-11 rightcont">
                <label class="radiobeuty" data-id="1">
                    <input class="defaultradio" data-id="1"  type="radio" name="yhqtype" ${rule.isShow eq 1?"checked":""}>
                    <span class="radioInput"></span>是
                </label>
                <label class="radiobeuty" data-id="0">
                    <input class="defaultradio" data-id="0" type="radio" name="yhqtype" ${rule.isShow eq 0?"checked":""}>
            ...
            <div class="col-md-11 rightcont">
                <textarea type="text" autocomplete="off" class="inputxt" name="remark">${rule.remark}</textarea>
            </div>
            <div class="clearfloat"></div>
            <div class="surebtn">
            ...
            <input type="hidden" name="recKey" value="${rule.recKey}"/>
        </div>
    </div>
    <!--选择优惠券-->
