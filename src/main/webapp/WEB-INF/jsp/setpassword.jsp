    ...
    <div class="content bodycont">
        <div class="importToolip display">
            <div class="warninginfo">
                <p><i class=" icon-exclamation-sign"></i>还未设置密码，请设置！</p>
            </div>
        </div>
        <div id="passwordFrom">
            ...
            <div class="form-group">
                ...
                <div class="col-md-11">
                    ...
                    <span class="errortoolip display">密码设置在6-18位字符之间！</span>
                </div>
                <div class="clearfloat"></div>
            </div>
            <div class="form-group">
            ...
            <button class="btn btn-primary btn_locpassword">确认</button>
        </div>
    </div>
    <!--jquery-->
