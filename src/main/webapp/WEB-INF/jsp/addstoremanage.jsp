...
<body>
    <div class="content">
        ...
        <div class="bodycont addcouponpage">
                ...
                <select id="id_select" class="selectpicker" data-live-search="true">
                    <c:if test="${locs!=null && fn:length(locs)>0}">
                        <c:forEach var="loc" items="${locs}">
                            <option data-id="${loc.orgName}" data-phone="${loc.contractWay}">${loc.orgId}</option>
                        </c:forEach>
                    </c:if>
                    <c:if test="${locs==null || fn:length(locs)==0}">
            ...
            <div class="col-md-11 rightcont">
                <input type="text" value="${loc.orgName}" class="storename" name="locName" disabled/>
            </div>
            <div class="clearfloat"></div>
            <div class="col-md-1 leftlabel"><label class="defaultLabel"><span class="importantinfo">*</span>原门店编码：</label></div>
            <div class="col-md-11 rightcont">
                <input type="text" value="${loc.orgId}" class="prevstoreId" name="orgId"/>
            </div>
            <div class="clearfloat"></div>
            ...
            <div class="col-md-11 rightcont storedata">
                <input type="text" readonly name="endDate" class="usestart" value=""/>
                <i class="icon-calendar"></i>
            </div>
            <div class="clearfloat"></div>
            ...
            <div class="col-md-11 rightcont">
                <label class="radiobeuty">
                    <input class="defaultradio" type="radio" name="status" data-id="1"  checked >
                    <span class="radioInput"></span>是
                </label>
                <label class="radiobeuty">
                    <input class="defaultradio" type="radio" name="status" data-id="0">
