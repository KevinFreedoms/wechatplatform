    ...
    <div class="content">
        ...
        <div class="bodycont addgiftpro">
            ...
            <div class="col-md-4">
                ...
                <div class="pull-left rightcont">
                    <input type="text" class="commodityId" id="commodityId" value="${commodityId}" disabled>
                </div>
            </div>
            <div class="col-md-8">
                <div class="pull-left leftlabel"><label class="defaultLabel"><span class="importantinfo">*</span>兑换积分：</label></div>
                <div class="pull-left rightcont">
                    <input type="text" id="integral" onkeyup='this.value=this.value.replace(/\D/gi,"")'>
                </div>
            </div>
            <div class="clearfloat"></div>
            <div class="col-md-4">
            ...
            <div class="col-md-8">
                ...
                <div class="pull-left rightcont">
                    <input type="text" id="salePrice"  onkeyup='num(this)'><span style="color:#999999">元</span>
                </div>
            </div>
            <div class="clearfloat"></div>
            ...
            <div class="col-md-8">
                ...
                <div class="pull-left rightcont">
                    <input type="text" readonly name="reservation" class="reservation " value="" id="startDate"/>
            ...
            <div class="col-md-4">
                ...
                <div class="pull-left rightcont">
                    <input type="text" id="totalQuantity" onkeyup='this.value=this.value.replace(/\D/gi,"")'>
                </div>
                <div class="clearfloat"></div>
            </div>
            <div class="col-md-8">
                ...
                <div class="pull-left rightcont">
                    <input type="text" readonly name="reservation" class="reservation " value="" id="endDate"/>
                    <i class="icon-calendar"></i>
                </div>
            </div>
            <div class="clearfloat"></div>
            <div class="col-md-12 ">
                <div class="pull-left leftlabel"><label class="defaultLabel"><span class="importantinfo">*</span>启用状态：</label></div>
                <div class="pull-left rightcont">
            ...
            <div class="col-md-12">
                ...
                <div class="pull-left rightcont">
                    <input type="text" class="remark" id="remark"/>
                </div>
                <div class="clearfloat"></div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="pull-left rightcont">
                    <input type="text" class="stand" id="spec"/>
                </div>
                <div class="clearfloat"></div>
            </div>
            <div class="col-md-12">
                ...
                <div class="pull-left rightcont">
                    <input type="text" class="remark" id="description"/>
                </div>
                <div class="clearfloat"></div>
            </div>
            <div class="col-md-12">
                ...
                <div class="pull-left rightcont">
                    <textarea id="editor_id" name="content" style="width:57%;height:350px;visibility:hidden;margin-left:10px;"></textarea>
                </div>
                <div class="clearfloat"></div>
            </div>
        </div>
