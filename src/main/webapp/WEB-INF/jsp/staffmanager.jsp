...
<body>
    ...
    <!--新增员工-->
    <div class="modal fade" data-backdrop="static" id="addstaff" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <form class="form-horizontal tasi-form staffform" name="">
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="col-sm-3 leftlabel"><label class="defaultLabel"><span class="importantinfo">*</span>员工编码：</label></div>
                            <div class="col-sm-9 rightarea">
                                <input type="text" class="inputxt" name="staffId" value="" disabled="disabled"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-3 leftlabel"><label class="defaultLabel">地址：</label></div>
                            <div class="col-sm-9 rightarea">
                                <textarea type="text"class="inputxt"  name="address" value=""></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-3 leftlabel"><label class="defaultLabel"><span class="importantinfo">*</span>员工名称：</label></div>
                            <div class="col-sm-9 rightarea">
                                <input type="text" autocomplete="off" class="inputxt" name="staffName" value=""/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-3 leftlabel"><label class="defaultLabel"><span class="importantinfo">*</span>联系方式：</label></div>
                            <div class="col-sm-9 rightarea">
                                <input type="text" autocomplete="off" class="inputxt" name="phone" value=""/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-3 leftlabel"><label class="defaultLabel"><span class="importantinfo">*</span>所属门店：</label></div>
                            <div class="col-sm-9 rightarea">
                                <select id="loclist">
                        ...
                        <div class="form-group">
                            <div class="col-sm-3 leftlabel"><label class="defaultLabel"><span class="importantinfo">*</span>角色：</label></div>
                            <div class="col-sm-9 rightarea">
                                <select id="rolelist">
                        ...
                        <div class="form-group">
                            <div class="col-sm-3 leftlabel"><label class="defaultLabel">启用状态：</label></div>
                            <div class="col-sm-9 rightarea">
                        ...
                        <div class="form-group">
                            <div class="col-sm-3 leftlabel"><label class="defaultLabel">备注：</label></div>
                            <div class="col-sm-9 rightarea">
                    ...
                    <div class="modal-footer">
                        <label class="label_warning"></label><br>
                        <button class="btn btn-primary btn-sure" type="button">确定</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        document.write("<s"+"cript type='text/javascript' src='<%=basePath%>js/page/staff/staff.js?"+Math.random()+"'></scr"+"ipt>");
    </script>
