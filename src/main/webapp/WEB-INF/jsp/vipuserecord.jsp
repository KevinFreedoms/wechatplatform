...
<div class="content">
    ...
    <div class="menuchange navtab">
        <ul>
            <li class="active" data-type="recharge">充值记录</li>
            <li data-type="consume">扣款记录</li>
            <li data-type="changeintegration">积分记录</li>
        </ul>
        <div class="clearfloat"></div>
    </div>
    <div class="recordtb">
        <table id="viprecordTab">
        </table>
    </div>
</div>
<!--jquery-->
...
<script>
    ...
    document.write("<s"+"cript type='text/javascript' src='<%=basePath%>js/page/member/vipuserecord.js?"+Math.random()+"'></scr"+"ipt>");
</script>
<script>
    $(function () {
        basePath = "<%=basePath%>";
